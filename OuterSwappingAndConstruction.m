function [Xerr, Zerr] = OuterSwappingAndConstruction(L0, sigGKP, etas, etam, etad, etac, Lcavity, k, v, N)
...
parfor i = 1:N
    logErrOuter = UW2_OuterLeaves(L0, sigGKP, etas, etad, etac, k, ErrProbVec);
